****************************************************************
  ...
  Removes all duplicate points from a LAS/LAZ/ASCII file. Those
  are points with identical x and y coordinates. The first point
  survives all subsequent duplicates are removed.
  ...
  https://lidarbb.cr.usgs.gov/index.php?showtopic=12898
