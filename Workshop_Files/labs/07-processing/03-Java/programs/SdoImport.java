...
public final class SdoImport
{
  ...
  public static void main(String args[]) throws Exception
  {
    ...
    if (args.length < 8) {
      ...
      System.out.println ("<Table name>:   Table to import (must already exist)");
    ...
    String  inputFormat       = args[7].toUpperCase();
    ...
    throws Exception
  {
    ...
    if (inputFormat.equals("JAVA"))
      ...
      System.out.println (inputFormat + " is an invalid input format");
      return;
    }
